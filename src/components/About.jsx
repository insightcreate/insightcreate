        ...
        <>
            <div className="relative flex flex-col items-center text-center lg:py-10 md:py-10 py-6 px-6 bg-iccardpurple">
                ...
                <div className="w-full max-w-7xl mx-auto">
                    <p className="text-icblack text-sm text-left">Home / <span className="font-bold">About Us</span></p>
                </div>
            ...
            <div className="relative flex flex-col items-center text-center lg:py-16 md:py-10 py-6 px-6 bg-iccardpink">
                {/* Title */}
            ...
            <div className="relative flex flex-col items-center text-center lg:py-16 md:py-10 py-6 px-6 bg-iccardyellow">
                {/* Title */}
                <h1 className="lg:text-6xl md:text-5xl text-4xl font-medium text-icblack">
                    Our Mission
                </h1>
            ...
            <div className="relative flex flex-col items-center text-center lg:py-16 md:py-10 py-6 px-6 bg-iccardgreen">
                {/* Title */}
                <h1 className="lg:text-6xl md:text-5xl text-4xl font-medium text-icblack">
                    What We Do
                </h1>
                ...
                {/* Subtitle */}
                <p className="text-icblack text-sm md:text-xl mt-4 max-w-4xl z-10 relative text-left">
